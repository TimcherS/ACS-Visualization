...
namespace ACSVisualization.Misc
{
    public class PieMenuItem : HeaderedItemsControl
    {
        ...
        public static readonly DependencyProperty ReverseRotationProperty;
        ...
        public bool ReverseRotation
        {
            get
            {
                return (bool)base.GetValue(PieMenuItem.ReverseRotationProperty);
            }
            set
            {
                base.SetValue(PieMenuItem.ReverseRotationProperty, value);
            }
        }
        ...
        static PieMenuItem()
        {
            ...
            PieMenuItem.ReverseRotationProperty = DependencyProperty.Register("ReverRotation", typeof(bool), typeof(PieMenuItem), new FrameworkPropertyMetadata(null));
        }
